...
contract Constants {
    uint public constant MAX_CONTRACT_REWARD_BP = 30000; // 300%

    uint public constant LP_FEE_BP = 1000; // 10%
    uint public constant REF_COMMISSION_BP = 700; // 10%
    ...
    uint public constant CONTRACT_BONUS_UNIT = 100;    // For each 100 token balance of contract, gives
